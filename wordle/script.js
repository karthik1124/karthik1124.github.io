...
const targetWord = targetWords[Math.floor(dayOffsetFromRefDate % targetWords.length)];
...
const targetDiv = document.getElementById("keyboard");
...
function hint(){
  let h="Word starts with "+targetWord[0].toUpperCase()
  showAlert(h)
}